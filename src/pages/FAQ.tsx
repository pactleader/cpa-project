          ...
          <section className="py-16">
            <div className="container mx-auto px-4">
              ...
              <Tabs defaultValue="general" className="max-w-6xl mx-auto">
                <TabsList className="grid w-full grid-cols-2 md:grid-cols-5 mb-8 bg-gray-100 p-2 rounded-lg">
                  {Object.entries(categoryLabels).map(([key, label]) => {
                    ...
                    return (
                      <TabsTrigger
                        key={key}
                        value={key}
                        className="flex flex-col items-center gap-2 py-4 px-2 data-[state=active]:bg-white data-[state=active]:shadow-sm rounded-md transition-all duration-200"
                      >
